...
namespace ADO
{
    public partial class Form13 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand("update buyerreg set PASSWORD=@PASSWORD,CONFIRMPASSWORD=@CONFIRMPASSWORD,NAME=@NAME,GENDER=@GENDER,PHONE=@PHONE,AGE=@AGE,EMAIL=@EMAIL WHERE USERNAME=@USERNAME", conn);

...
namespace ADO
{
    public partial class Form11 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand("update sellerreg set PASSWORD=@PASSWORD,CONFIRMPASSWORD=@CONFIRMPASSWORD,NAME=@NAME,GENDER=@GENDER,PHONE=@PHONE,AGE=@AGE,EMAIL=@EMAIL WHERE USERNAME=@USERNAME",conn);
